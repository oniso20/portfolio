...
export const useProject = () => {
    const [featuredProjects] = useState([
        ...
        { name: 'Portfolio', description: 'This personal website is a showcase of my skills and experience as a software developer. From my notable projects to my resume and contact information, this site serves as a comprehensive overview of my projects, capabilities and interests.', image: 'https://via.placeholder.com/300x200' },
    ]);

    const [learningProjects] = useState([
